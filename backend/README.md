...
## Project Structure
    ...
    ├── welcomescreenapp_de_91840  # Django project configurations
...
1. Clone this repo and `cd welcomescreenapp_de_91840`
...
2. Clone this repo and `cd welcomescreenapp_de_91840`
